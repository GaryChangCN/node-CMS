    ...
    <div class="middle">
      <div class="table">
        <el-table :data="setContent.info.customerProduct" style="width: 100%" border>
          ...
          <el-table-column prop="number" v-bind:label="toggleEnglish?'Product No.':'产品编号'" align="center" width="100">
          </el-table-column>
          <el-table-column inline-template v-bind:label="toggleEnglish?'Product Picture':'产品图'" align="center" width="160">
